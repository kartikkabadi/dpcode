...
export default function WorkspaceView({ workspaceId }: { workspaceId: string }) {
  ...
  return (
    <SidebarInset className="overflow-hidden h-dvh min-h-0 overflow-hidden overscroll-y-none bg-background/40 text-foreground">
      <div className="glass-panel--soft overflow-hidden flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden bg-background/40">
        <header className="glass-panel--soft border-b border-border/60 bg-background/45 px-3 sm:px-5">
        ...
        <div className="min-h-0 min-w-0 flex-1">
          {!homeDir ? (
            ...
            <div className="flex h-full items-center justify-center px-6">
              <div className="glass-panel--soft overflow-hidden max-w-sm rounded-3xl border border-border/70 bg-card/40 p-6 text-center shadow-sm">
